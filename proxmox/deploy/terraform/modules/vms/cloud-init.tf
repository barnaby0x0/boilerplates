resource "proxmox_virtual_environment_file" "cloud_user_config" {
  ...
  source_raw {
    data = templatefile("${path.module}/templates/cloud-init/user_data", {
...
resource "proxmox_virtual_environment_file" "cloud_network_config" {
  ...
  source_raw {
    data = templatefile("${path.module}/templates/cloud-init/network_data", {
...
resource "proxmox_virtual_environment_file" "cloud_meta_config" {
  ...
  source_raw {
    data = templatefile("${path.module}/templates/cloud-init/meta_data",
      {
